...
import { LAYER_BUS_STOPS, LAYER_ML_STOPS, LAYER_CENSUS_COUNTIES, LAYER_CENSUS_TRACTS, LAYER_CYCLING, } from "../layers.js";
export const TAG = "map-window";
export function newMapCoords(xmin, ymin, xmax, ymax, wkid) {
...
export class MapWindow extends HTMLElement {
    constructor() {
        ...
        }, (e) => console.error("failed to build or display map:", e));
        ...
        try {
            if (meta.dataUrl) {
                ...
                if (meta.toGraphics) {
                    ...
                    meta.source = data.features.map((f) => new Graphic({
